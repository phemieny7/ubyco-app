  ...
  return (
    ...
    >
      ...
      <DrawerTab.Screen
        ...
        options={{
          drawerIcon: () => (
            <MaterialCommunityIcons name="cards" size={24} color="#f63757" />
          ),
        }}
      />
      ...
      <DrawerTab.Screen
        ...
        options={{
          drawerIcon: () => (
            <MaterialCommunityIcons name="bitcoin" size={24} color="#f63757" />
          ),
        }}
      />
      ...
      <DrawerTab.Screen
        ...
        component={HistroyNavigator}
        options={{
          drawerIcon: () => (
            <AntDesign name="book" size={24} color="#f63757" />
          ),
        }}
      />
      ...
      <DrawerTab.Screen
        ...
        options={{
          drawerIcon: () => (
            <MaterialCommunityIcons name="bank" size={24} color="#f63757" />
          ),
        }}
      />
      ...
      <DrawerTab.Screen
        ...
        options={{
          drawerIcon: () => <AntDesign name="user" size={24} color="#f63757" />,
        }}
      />
